function F_1_ = GetF_1_( A_1_, N_1_, N_1_LAG_, nu, gamma, Gamma, L_1_, lambda, phi_, deltaJ, GJTrend_, AverageTransportCost_, thetaC, thetaF, thetaH, kappa, alpha, GYTrend_, GSRKTrend_, P_1_Over_Q_1_, Xi_LEAD_, deltaK, Phi2, GSPTrend_, GZTrend_, xi, GPTrend_, GYBarTrend_, GOmega1Trend_, Pi_)
...
function Residual = GetResidual( F_1_K_1_H_1_Q_1_, A_1_, N_1_, N_1_LAG_, nu, gamma, Gamma, L_1_, lambda, phi_, deltaJ, GJTrend_, AverageTransportCost_, thetaC, thetaF, thetaH, kappa, alpha, GYTrend_, GSRKTrend_, P_1_Over_Q_1_, Xi_LEAD_, deltaK, Phi2, GSPTrend_ , GZTrend_, xi, GPTrend_ , GYBarTrend_, GOmega1Trend_, Pi_)
    F_1_ = F_1_K_1_H_1_Q_1_( 1 );
