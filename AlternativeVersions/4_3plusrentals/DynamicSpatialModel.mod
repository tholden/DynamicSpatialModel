...
model;
    ...
    @#for Point1 in 1 : SpatialNumPoints
        ...
        #SRD@{Index1} = SRL@{Index1} - PhiL * ( L@{Index1} / L@{Index1}_LAG - 1 ) / L@{Index1}_LAG + Xi_LEAD * PhiL * ( L@{Index1}_LEAD / L@{Index1} - 1 ) * ( L@{Index1}_LEAD / ( L@{Index1}^2 ) );
        ...
        thetaL * E@{Index1} = thetaF * SRD@{Index1} * D@{Index1}; 
