...
for var_iter=1:opt.num_vars
    ...
    eval(['plot(results.model{1,1}.',char(opt.vars_to_plot(var_iter)),'(1:',num2str(opt.irf_horizon),')-results.model{1,2}.',char(opt.vars_to_plot(var_iter)),'(1:',num2str(opt.irf_horizon),')); hold on;']);
