function E_1_by_F_1_ = GetE_1_by_F_1( shape , Index, SpatialPointsPerDimension,  GN_ , nu, gamma, Gamma, Omega, lambda, phi_, deltaJ, GJTrend_, thetaC, thetaF, thetaH, thetaL, thetaN, kappa, alpha, GYTrend_, GSRKTrend_, Xi_LEAD_, deltaK, Phi2, GSPTrend_ , GmuNTrend_, GUTrend_, psi1, psi2, psi3, tau_, dBar, beta_ , varsigma)
    ...
    %lb = zeros( (6 + SpatialPoints)* SpatialPoints , 1 );
    ...
    lb = [];
    E_x_by_F_x_N_x_F_x_K_x_H_x_Q_x_SN_xx_ = exp( fmincon( @( log_E_x_by_F_x_N_x_F_x_K_x_H_x_Q_x_SN_xx_ ) GetResidual( exp( log_E_x_by_F_x_N_x_F_x_K_x_H_x_Q_x_SN_xx_ ), shape, SpatialPointsPerDimension, d, GN_ , nu, gamma, Gamma, Omega, lambda, phi_, deltaJ, GJTrend_, thetaC, thetaF, thetaH, thetaL, thetaN, kappa, alpha, GYTrend_, GSRKTrend_, Xi_LEAD_, deltaK, Phi2, GSPTrend_, GmuNTrend_, GUTrend_, psi1, psi2, psi3, tau_, dBar, beta_ , varsigma), ...
      log( [ E_by_F_0' , N_0' , F_0' , K_0' , H_0' , Q_0' , SN_0' ]' ), ...
      A,b,[],[],lb,[],@( log_E_x_by_F_x_N_x_F_x_K_x_H_x_Q_x_SN_xx_ ) constraints( exp( log_E_x_by_F_x_N_x_F_x_K_x_H_x_Q_x_SN_xx_ ), shape, SpatialPointsPerDimension, d, GN_ , nu, gamma, Gamma, Omega, lambda, phi_, deltaJ, GJTrend_, thetaC, thetaF, thetaH, thetaL, thetaN, kappa, alpha, GYTrend_, GSRKTrend_, Xi_LEAD_, deltaK, Phi2, GSPTrend_, GmuNTrend_, GUTrend_, psi1, psi2, psi3, tau_, dBar, beta_ , varsigma),...
