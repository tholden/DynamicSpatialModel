function F_1_ = GetF_1_( A_1_, N_1_LAG_, nu, gamma, Gamma, L_1_, lambda, phi_, deltaJ, GJTrend_, AverageTransportCost_, thetaC, thetaF, thetaH, kappa, alpha, GYTrend_, GSRKTrend_, P_1_Over_Q_1_, Xi_LEAD_, deltaK, Phi2, GSPTrend_ )
    global F_1_K_1_H_1_Q_1_
    F_1_K_1_H_1_Q_1_ = exp( fsolve( @( log_F_1_K_1_H_1_Q_1_ ) GetResidual( exp( log_F_1_K_1_H_1_Q_1_ ), A_1_, N_1_LAG_, nu, gamma, Gamma, L_1_, lambda, phi_, deltaJ, GJTrend_, AverageTransportCost_, thetaC, thetaF, thetaH, kappa, alpha, GYTrend_, GSRKTrend_, P_1_Over_Q_1_, Xi_LEAD_, deltaK, Phi2, GSPTrend_ ), ...
...
function Residual = GetResidual( F_1_K_1_H_1_Q_1_, A_1_, N_1_LAG_, nu, gamma, Gamma, L_1_, lambda, phi_, deltaJ, GJTrend_, AverageTransportCost_, thetaC, thetaF, thetaH, kappa, alpha, GYTrend_, GSRKTrend_, P_1_Over_Q_1_, Xi_LEAD_, deltaK, Phi2, GSPTrend_ )
    F_1_ = F_1_K_1_H_1_Q_1_( 1 );
    ...
    Residual( 2 ) = thetaF * N_1_LAG_ / F_1_ * W_1_ * ( 1 / ( 1 + nu ) * Gamma ^ ( 1 + nu ) - 1 / ( 1 + nu ) * ( H_1_ / N_1_LAG_ ) ^ ( 1 + nu ) ) - thetaH * ( H_1_ / N_1_LAG_ ) ^ nu;
